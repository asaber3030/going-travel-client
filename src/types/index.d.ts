...
export type UpdateTourFormType = "itineraries" | "images" | "highlights" | "exclusions-inclusions" | "reviews"
...
type Limousine = Timestamps &
  Creator & {
    ...
    category: Category
    location: Location
    translations: LimousineTranslation[]
  }

type LimousineReview = Timestamps &
  Creator & {
    id: number
    limousine_id: number
...
type LimousineFeature = Timestamps &
  Creator & {
    id: number
    limousine_id: number
    locale: string
...
type LimousineService = Timestamps &
  Creator & {
    id: number
    limousine_id: number
    locale: string
...
type LimousineSpecification = Timestamps &
  Creator & {
    id: number
    limousine_id: number
    locale: string
...
type LimousineOverview = Timestamps &
  Creator & {
    id: number
    limousine_id: number
    locale: string
...
type LimousineImage = Timestamps &
  Creator & {
    id: number
    limousine_id: number
    url: string
...
type LimousineTranslation = Timestamps &
  Creator & {
    id: number
    limousine_id: number
    locale: string
