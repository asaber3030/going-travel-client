      ...
      <div ref={parallaxRef} className='relative h-[500px] flex items-center justify-center'>
        ...
        <div className='container mx-auto px-4 relative z-10 text-center'>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className='max-w-3xl mx-auto'>
            ...
            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className='bg-white text-teal-600 px-8 py-3 rounded-md font-medium text-lg shadow-lg hover:shadow-xl transition-all'>
              {t("homePageLandingButton")}
            </motion.button>
          </motion.div>
        </div>
      </div>
