...
export default function LandingHeroSection() {
  ...
  return (
    <div className="relative bg-teal-600 overflow-hidden">
      <div ref={parallaxRef} className="relative h-[500px] flex items-center justify-center">
        {/* Decorative elements */}
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-teal-50 mb-8">Experience premium travel services tailored to your needs</p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white text-teal-600 px-8 py-3 rounded-md font-medium text-lg shadow-lg hover:shadow-xl transition-all"
            >
              Explore Services
            </motion.button>
          </motion.div>
