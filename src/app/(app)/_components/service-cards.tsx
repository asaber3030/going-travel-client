...
export default function ServiceCards() {
  ...
  const services: Service[] = [
    {
      id: "tours",
      title: t("services.tour_packages.title"),
      description: t("services.tour_packages.description"),
    ...
    {
      id: "hotels",
      title: t("services.hotel_booking.title"),
      description: t("services.hotel_booking.description"),
    ...
    {
      id: "limo",
      title: t("services.limousine_service.title"),
      description: t("services.limousine_service.description"),
  ...
  return (
    <motion.div className='grid grid-cols-1 md:grid-cols-3 gap-8' variants={container} initial='hidden' whileInView='show' viewport={{ once: true, margin: "-100px" }}>
          ...
          <Link href={service.link} className='block'>
            ...
            <div className='p-6'>
              ...
              <div className='flex items-center text-teal-600 font-medium'>
                {t("services.explore")}
                <svg xmlns='http://www.w3.org/2000/svg' className='h-5 w-5 ml-2 group-hover:translate-x-2 transition-transform' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
