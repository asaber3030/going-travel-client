      ...
      <Card className="sticky top-8">
        <CardContent className="p-6">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex justify-between py-2 border-b border-gray-100">
              ...
              <span>
                {" "}
                {Math.floor(
                  (new Date(hajData.return_date).getTime() - new Date(hajData.depature_date).getTime()) / (1000 * 60 * 60 * 24)
                )}{" "}
                يومًا
              </span>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <p className="font-medium text-emerald-600">اتصل بنا على (01111111111 20+)</p>
          </div>
        </CardContent>
      </Card>
    </div>
