          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4 text-white/80">
              <div className="flex items-center">
                ...
                <span>
                  {new Date(hajData.depature_date).toLocaleDateString("ar-GB")} -{" "}
                  {new Date(hajData.return_date).toLocaleDateString("ar-GB")}
                </span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span> {Math.floor((new Date("1-1-2002").getTime() - new Date("2-1-2002").getTime()) / (1000 * 60 * 60 * 24))} يوم</span>
              </div>
            </div>
          </div>
        </div>
