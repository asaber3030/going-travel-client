        ...
        {sortedHotels.length === 0 ? (
          ...
          <div className='space-y-6'>
            {sortedHotels.map((hotel, index) => (
              <motion.div key={hotel.id} initial='hidden' whileInView='visible' viewport={{ once: true }} variants={fadeInUp} transition={{ delay: index * 0.1 }}>
                      ...
                      <div className='flex flex-col h-full justify-between'>
                        ...
                        <div className='flex items-center justify-between mt-4'>
                          <div>
                            ...
                            <div className='flex items-baseline'>{<span className='text-2xl font-bold text-primary'>${hotel.price}</span>}</div>
                          </div>
                          <Button asChild>
