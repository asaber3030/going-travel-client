...
export function HotelDetailsMainContent({ hotel }: Props) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Tabs defaultValue="overview" className="w-full" dir={locale == "ar" ? "rtl" : "ltr"}>
        <TabsList className="flex-row justify-end">
        ...
        <TabsContent value="reviews" dir={locale == "ar" ? "rtl" : "ltr"}>
                ...
                {hotel.reviews.map((review) => (
                  <Card key={review.id} className="overflow-hidden">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex items-center gap-3">
                          <Avatar className="h-10 w-10 border">
                            <AvatarImage
                              src={`/placeholder.svg?height=40&width=40&text=${getInitials(review.client_name)}`}
                    ...
                    <CardContent className="pb-3">
                      <p className={`text-sm ml-12 ${!isReviewExpanded(review.id) && review.message.length > 150 ? "line-clamp-3" : ""}`}>
                        {review.message}
                      </p>
