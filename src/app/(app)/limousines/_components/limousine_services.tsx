...
export default function LimousineServices() {
  return (
    <section className="bg-muted/30 py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">Discover our range of luxury transportation options for every occasion</p>
        </div>
